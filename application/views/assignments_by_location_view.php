...
<?php $total_number_of_workers = $this->graduate_model->get_row_count() ;?>
<div class="row">
    ...
    <table id="etable" class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th title="% Workers Assigned to Top 3 Preferences"> <?php echo get_percentage($total_allocated_workers,
